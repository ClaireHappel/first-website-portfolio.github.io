...
You'll be creating a whole web page from scratch, from creating the `html` file, to writing all the `<html>` tags, adding content and style with CSS.
...
2. Inside of that folder, you should see a file called `first-website.html`.

Add the following boilerplate code to this `first-website.html` file to get started:
